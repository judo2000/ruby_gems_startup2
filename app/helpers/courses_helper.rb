  ...
  def enrollment_button(course)
    if current_user
      if course.user == current_user 
        link_to "Your created this course. View Analytics", course_path(course)
      elsif course.enrollments.where(user: current_user).any?
        link_to "You are already enrolled in this course. Continue learning", course_path(course)
